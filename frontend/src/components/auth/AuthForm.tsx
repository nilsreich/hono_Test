...
/**
 * Props für AuthForm.
 * Form-State (username, password) wird intern verwaltet,
...
interface AuthFormProps {
  ...
  onSignup: (username: string, password: string) => Promise<boolean> // Signup-Handler
}
 ...
 */
export function AuthForm({ loading, error, onLogin, onSignup }: AuthFormProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const success = await handler(username, password)
